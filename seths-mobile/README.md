# SETHS — Android .apk build (app id: za.gods.seths)

Capacitor project that compiles the **seths-app** web app into a native Android `.apk`.
...
- `capacitor.config.json` — app id za.gods.seths, cleartext enabled for the connect-screen
