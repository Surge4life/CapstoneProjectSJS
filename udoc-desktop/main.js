...
const APP_URL = process.env.GODS_URL || "https://gods-platform-core.onrender.com";
...
function createWindow() {
  ...
  win.webContents.on("did-fail-load", () => {
    win.loadURL("data:text/html;charset=utf-8," + encodeURIComponent(
      ...
      "<div><h1>UDOC Control</h1><p style='color:#D0C8B0'>Could not reach the G.O.D.S deployment.</p>" +
