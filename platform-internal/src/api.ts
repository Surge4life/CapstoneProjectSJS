const BASE = import.meta.env.VITE_API_BASE || "https://gods-platform-core.onrender.com";
let token: string | null = localStorage.getItem("gods_int_token");
export function setToken(t: string | null) {
  token = t;
  t ? localStorage.setItem("gods_int_token", t) : localStorage.removeItem("gods_int_token");
}
