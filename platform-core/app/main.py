...
from app.routers import (health, auth, registry, decisions, audit, oversight,
                         ...
                         system_backup, users_admin, client_knowledge, workspace, sectors, rbac, portal_ops, conformance, manifest, udoc_engine, staychain)
...
for r in (health.router, auth.router, registry.router, decisions.router, audit.router,
          ...
          manifest.router, udoc_engine.router, staychain.router):
