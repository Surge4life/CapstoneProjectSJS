...
from app.routers import (health, auth, registry, decisions, audit, oversight,
                         ...
                         system_backup, users_admin, client_knowledge, workspace, sectors)
...
for r in (health.router, auth.router, registry.router, decisions.router, audit.router,
          ...
          system_backup.router, users_admin.router, client_knowledge.router, workspace.router, sectors.router):
