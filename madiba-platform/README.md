# MADIBA Platform (standalone, React + Vite + recharts)
Dedicated division platform for **MADIBA — Capital Recycling**, wired to platform-core's
division API **and** the UDOC data-record-and-analytics layer (`/analytics/MADIBA/*`).
