# TS Industries — Desktop App (.exe via Electron)

Wraps the live TS Industries site in a native desktop window. It loads your deployed
...
```
Output in `release/`:
- `TS Industries Setup 1.0.0.exe`  — installer (creates Start-menu + desktop shortcut)
- `TS Industries 1.0.0.exe`        — portable (run directly, no install)
