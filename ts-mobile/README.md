# TS Industries — Android .apk build (app id: za.gods.ts)

Capacitor project that compiles the **ts-app** web app into a native Android `.apk`.
...
- `capacitor.config.json` — app id za.gods.ts, cleartext enabled for the connect-screen
