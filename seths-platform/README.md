# SETHS Platform (standalone, React + Vite + recharts)
Dedicated division platform for **SETHS — Workforce Reintegration**, wired to platform-core's
division API **and** the UDOC data-record-and-analytics layer (`/analytics/SETHS/*`).
